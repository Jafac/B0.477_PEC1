...
#frecuencia de los 10 primeros terminos en los 10 primeros documentos
...
```{r,eval=TRUE,echo=TRUE,warning=FALSE, message=FALSE}
ggplot(subset(fdata, Frecuencia>0),aes(Palabra,Frecuencia,fill=Tematica))+geom_bar(stat="identity",position=position_dodge())+theme(axis.text.x=element_text(angle=45, hjust=1))
```

El total de palabras "acq" es 42. (falta ver para frecuencia mayor a 500)
El total de palabras "earn" es 29. (falta ver para frecuencia mayor a 500)
El total de palabras sera 42 - 71 (42+29)

La idea basica es: cuantas mas barras bi-color hay (palabras en los dos grupos) mas similares son los temas y por tanto más costara diferenciar un topic de otro.
